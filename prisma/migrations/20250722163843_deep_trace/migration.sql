...
-- CreateEnum
CREATE TYPE "DetectionLabel" AS ENUM ('REAL', 'AI', 'MORPHED', 'UNKNOWN');
...
CREATE TABLE "ImageScan" (
    ...
    "mimeType" TEXT,
    "sizeBytes" INTEGER,
    "label" "DetectionLabel" NOT NULL DEFAULT 'UNKNOWN',
...
-- CreateIndex
CREATE INDEX "ImageScan_label_idx" ON "ImageScan"("label");

-- CreateIndex
CREATE INDEX "ImageScan_scannedAt_idx" ON "ImageScan"("scannedAt");
